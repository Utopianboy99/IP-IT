    ...
    <>
      ...
      <div className="box1">
        ...
        <div className="box-1-buttons">
          <button>
            <Link to='/courses' element={<Courses />} /> Start Learning
          </button>
          <button>
            <Link to='/signup' element={<SignupPage />} /> Join
          </button>
        </div>
      </div>
      ...
      <section className='features'>
        ...
        <div className="features-btns">
          <button>
            <Link to='/signup' element={<SignupPage />} />Start
          </button>
          <button>
            <Link to='/loging' element={<LoginPage />} />Join {`>`}
          </button>
        </div>
      </section>
      ...
      <section className="user-feedback">
        {!user ? (
          <div>Feedback carousel will go here</div>
        ) : (
          <div></div>
        )}
      </section>
